...
<div class="flex flex-wrap justify-center mt-8">
    ...
    @else
    <a href="{{ route('games.create') }}" class="bg-blue-500 hover:bg-blue-700 text-black py-2 px-4 rounded">Create game</a>
    @endguest
        ...
        <div class="flex flex-wrap justify-between">
            ...
            <div class="m-4">
                <div class="box-content h-56 w-40 p-4 border border-purple-500 shadow-md">
                    ...
                    <div class="pt-3">
                        @auth
                        @if(auth()->user()->id === $game->user_id)// betekent het dat je pas delete en edit kan doen als de id gelijk is aan de gameId?
                        ...
                        @endauth
                        @guest
                    <a href="{{ route('login') }}" class="bg-blue-500 hover:bg-blue-700 text-black py-2 px-4 rounded">Go to game</a>
                    @else
                    <a href="{{ $game->link }}" class="bg-blue-500 hover:bg-blue-700 text-black py-2 px-4 rounded">Go to game</a>
                    @endguest
